...
public class GeneralTest {
	...
	private static final Heuristic[] heuristics = { new H1(), new H2() };

	private Board setUp(String fileName) throws IOException {
	...
	private Board getSolutionBoard(GPSSolution<CalcudokuRule, CalcudokuState> solution) {
	...
	public void test3() throws IOException {
		...
		int[][] answers = { { 0, 0, 3 }, { 0, 1, 1 }, { 0, 2, 2 }, { 1, 0, 2 }, { 1, 1, 3 }, { 1, 2, 1 },
				{ 2, 0, 1 },
				{ 2, 1, 2 }, { 2, 2, 3 } };
		runTest(fileName, answers);
	}
	...
	// 3x3
		...
		public void test4() throws IOException {
			...
			int[][] answers = { {0,0,2},{0,1,1},{0,2,3},{1,0,1},{1,1,3},{1,2,2},{2,0,3},{2,1,2},{2,2,1} };
			runTest(fileName, answers);
		}

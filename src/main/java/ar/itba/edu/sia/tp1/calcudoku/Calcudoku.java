...
public class Calcudoku implements GPSProblem<CalcudokuRule, CalcudokuState> {
    ...
    public Calcudoku(CalcudokuState initialState, GPSHeuristic<Calcudoku> heuristic) {
        this.initialState = initialState;
        this.rules = CalcudokuRule.buildRules(initialState.getN());
        this.heuristic = heuristic;
    }

    public Calcudoku(ProblemParser<CalcudokuState> problemReader, GPSHeuristic<Calcudoku> heuristic) {
